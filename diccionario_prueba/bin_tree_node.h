...
/*
template <typename T>
BinTreeNode* BinTreeNode <T>::leftRot(BinTreeNode *a){
	BinTreeNode *aux = a->_right;
	aux->_prev = a->_prev;
	a->_right = aux->_left;
...
template <typename T>
BinTreeNode* rightRot(BinTreeNode *a){
	BinTreeNode *aux = a->_left;
	aux->_prev = a->_prev;
	a->_left = aux->_right;
...
template <typename T>
BinTreeNode* leftRightRot(BinTreeNode *n){
	n->_left = leftRot(n->_left);
	return rightRot(n);
}


template <typename T>
BinTreeNode* rightLeftRot(BinTreeNode *n){
	n->der = rightRot(n->_right);
	return leftRot(n);
}


template <typename T>
int BinTreeNode <T>::height(BinTreeNode *n){
	if (n == NULL)
		return -1;
...
template<typename T>
void BinTreeNode <T>::setBf(){
	_bf = heiht(n->_right) - height(n->_left);
}
*/
