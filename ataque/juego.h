...
*/
   ...
   */
   ...
   //PRE:VECTORES DE PUNTERO A PERSONAJE VALIDOS.
   //POST: RECORRE LOS DOS VECTORES Y SI UN PERSONAJE ES DE AIRE LLAMA AL METODO sumarEnergia.
   void alimentarAire(Personaje** jugadorUno , Personaje ** jugadorDos);
